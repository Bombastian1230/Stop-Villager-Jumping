...
import stop.villager.jumping.item.BallAndChainItem;
...
public class StopVillagerJumpingMod implements ModInitializer {
	...
	public static final BallAndChainItem BALL_AND_CHAIN_ITEM =
			Registry.register(Registries.ITEM, new Identifier(MODID, "ball_and_chain"),
					new BallAndChainItem(new FabricItemSettings().maxCount(1)));
